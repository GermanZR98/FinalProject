...
<body>
    ...
    <a class="btn btn-primary btn-sm card-title"  href="index.php?mod=cancion&ope=index">CANCIONES</a>
    ...
    <a class="btn btn-primary btn-sm card-title"  href="index.php?mod=sugerencia&ope=create">Crear sugerencia</a>
    <a class="btn btn-primary btn-sm card-title"  href="index.php?mod=usuario&ope=cerrarSesion">Cerrar Sesion</a>
    </div>
